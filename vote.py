...
decision_one = "4ATCPJAL6QLEWWD4S5XXBSXAO3PIVXFHC7WSYLCCYCETEZKLJ2QDJ4HIUY"
decision_two = "IY7VXCDF5WUEATEQJOTGUHOL5QMGCDKQETHABBOUWR3PZ2S7ZSZSUEI7J4"
corporate_decision_one = "4ATCPJAL6QLEWWD4S5XXBSXAO3PIVXFHC7WSYLCCYCETEZKLJ2QDJ4HIUY"
corporate_decision_two = "IY7VXCDF5WUEATEQJOTGUHOL5QMGCDKQETHABBOUWR3PZ2S7ZSZSUEI7J4"
...
def election_voting(vote):
    ...
    if vote == 'YES': # Add more boolean statements for more decisions or candidates.
        TX_ID = choice_vote(escrow_address,escrow_key,decision_one,0,"Tabulated using Choice Coin") # choice_vote() function called for "YES".
        ...
        TX_ID = choice_vote(escrow_address,escrow_key,decision_two,0,"Tabulated using Choice Coin")
        message = "Ballot Tabulated. \n You can validate that your vote was counted correctly at https://testnet.algoexplorer.io/tx/" + TX_ID[1] + "." 
    return message
...
def show_results(yes_count,no_count):
    ...
    plt.savefig('/home/ayuba-ezekiel/Desktop/Voting/Choice_Coin_Voting/static/Figure_1.png')
    # Return the results.
...
def show_corporate_results(yes_count,no_count):
    ...
    plt.savefig('/home/ayuba-ezekiel/Desktop/Voting/Choice_Coin_Voting/static/Figure_2.png')
